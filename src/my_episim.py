...
Notes to self: (fmavrikaki)
- this file works only with the -vac (it has to be copied into the initial_conditions.nc and config.json
- doesn't work with the csv one
"""
...
class EpiSim:
    ...
    def run_model(self, override_config=None, override_model_state=None):
        ...
        if result.returncode != 0:
            # Read the log file to get the actual error
            try:
